...
(0, _jquery2.default)(function () {
    // cached selectors
    var $userMenu = (0, _jquery2.default)('#user-menu');
    var $lol = (0, _jquery2.default)('#lol');
    var $newCardNameInput = (0, _jquery2.default)('#new-card-name-input');
    var $newCardDescInput = (0, _jquery2.default)('#new-card-desc-input');
    var $addLabelDesc = (0, _jquery2.default)('#add-label-desc');
    var $cardPage = (0, _jquery2.default)('#current-card-page');
    var $cardPageName = (0, _jquery2.default)('#current-card-page-name');
    var $cardPageDesc = (0, _jquery2.default)('#current-card-page-description');
    var $cardPageAuthor = (0, _jquery2.default)('#current-card-page-author');
    var $cardPageLabelList = (0, _jquery2.default)('#current-card-page-label-list');
    var $fullCardModal = (0, _jquery2.default)('#card-modal');
    var $newListName = (0, _jquery2.default)('#list-adder-input');
    var $addLabelMenu = (0, _jquery2.default)('#add-label-menu');
    var $boardsList = (0, _jquery2.default)('#boards-list');
    var $boardMenu = (0, _jquery2.default)('#board-menu');
    var $boardMemberList = (0, _jquery2.default)('#board-member-list');
    var $boardMemberAddMenu = (0, _jquery2.default)('#board-member-add-menu');
    var $boardMemberInput = (0, _jquery2.default)('#new-board-member-input');
    var $addMemberNotice = (0, _jquery2.default)('#add-member-notice');
    var $newCardModal = (0, _jquery2.default)('#new-card-modal');
    var $formListAdderContainer = (0, _jquery2.default)('#form-list-adder-container');
    var $listAdderBtn = (0, _jquery2.default)('#list-adder-btn');
    var $listAdder = (0, _jquery2.default)('#list-adder');
    var $listAdderInput = (0, _jquery2.default)('#list-adder-input');
    var $editCardNameInput = (0, _jquery2.default)('#edit-card-name-input');
    var $editDescBtn = (0, _jquery2.default)('#current-card-page-edit-desc-btn');
    var $editCardDescInput = (0, _jquery2.default)('#edit-card-desc-input');
    var $editCardDescSubmit = (0, _jquery2.default)('#edit-card-desc-submit-btn');
    var $commentInput = (0, _jquery2.default)('#comment-input');
    var $cardActivityList = (0, _jquery2.default)('#card-activity-list');
    ...
    function createList(l) {
        ...
        var $newList = (0, _jquery2.default)('<li></li>', { class: 'list', 'data-lid': l._id });
        (0, _jquery2.default)('<div></div>', { class: 'list-topbar' }).append((0, _jquery2.default)('<h4></h4>', { class: 'list-name', text: l.name })).append((0, _jquery2.default)('<div></div>', { class: 'btn list-delete-btn', text: 'X' })).appendTo($newList);

        var $newCardList = (0, _jquery2.default)('<ul></ul>', { class: 'card-list' }).appendTo($newList);
        for (var i = 0; i < l.cards.length; ++i) {
            $newCardList.append(createCard(l.cards[i], l._id));
        }

        (0, _jquery2.default)('<p></p>', { class: 'card-add-link', text: 'Add a card...' }).appendTo($newList);
        return $newList;
    }

    function createCard(c, lid) {
        map[lid].cards[c._id] = { name: c.name, desc: c.desc, labels: c.labels, author: c.author, comments: c.comments };
        var $newCard = (0, _jquery2.default)('<li></li>', { class: 'card', 'data-lid': lid, 'data-cid': c._id });
        var $newCardLabelList = (0, _jquery2.default)('<ul></ul>', { class: 'card-label-surface-list' });
        if (c.labels) {
            for (var i = 0; i < c.labels.length; ++i) {
                $newCardLabelList.append(createLabelSurface(c.labels[i]));
            }
        }
        var $newCardName = (0, _jquery2.default)('<p></p>', {
            class: 'card-name',
            text: c.name
        });
        var $newCardAuthor = (0, _jquery2.default)('<div></div>', {
            class: 'card-author'
        }).append((0, _jquery2.default)('<span></span>', {
            class: 'card-member',
            text: c.author
        }));
        $newCard.append($newCardLabelList).append($newCardName).append($newCardAuthor).append((0, _jquery2.default)('<div class="div-clearer"></div>'));
        return $newCard;
    }

    function createLabelSurface(la) {
        var $newLabelSurface = (0, _jquery2.default)('<li></li>', { class: 'card-label-surface card-label-' + la.color });
        return $newLabelSurface;
    }

    function createCardLabel(la) {
        var $cardLabel = (0, _jquery2.default)('<li></li>', { class: 'card-label card-label-' + la.color }).append((0, _jquery2.default)('<span></span>', { class: 'card-label-text', text: la.desc }));
        return $cardLabel;
    }

    function createComment(comment) {
        var $comment = (0, _jquery2.default)('<li></li>', {
            class: 'card-activity'
        }).append((0, _jquery2.default)('<p></p>', {
    ...
    function sendToBoardPage() {
        var bid = (0, _jquery2.default)(this).attr('data-bid');
    ...
    function openListNameEdit() {
        ...
        var $editListNameInput = (0, _jquery2.default)('<input>', { type: 'text', class: 'edit-list-name-input' }).val($this.text());
    ...
    function openCardNameEdit() {
        $editCardNameInput.val($cardPageName.text()).show();
        $editCardNameInput.focus().select();
        $cardPageName.hide();
    }

    function openCardDescEdit() {
        $editCardDescInput.val($cardPageDesc.text()).show();
    ...
    function openNewCard() {
        ...
        $currentList = (0, _jquery2.default)(this).parent();
    ...
    function deleteList() {
        var $listToDelete = (0, _jquery2.default)(this).closest('.list');
    ...
    function openFullCard() {
        $currentCard = (0, _jquery2.default)(this);
    ...
    function addNewLabel() {
        var labelData = {
            color: (0, _jquery2.default)(this).find('span').text(),
    ...
    function deleteLabel() {
        var $labelToDelete = (0, _jquery2.default)(this);
    ...
    socket.on('newBoardMember', function (data) {
        $boardMemberList.append((0, _jquery2.default)('<li></li>', {
            class: 'card-member',
            text: data.username
        }));
    });
    ...
    (0, _jquery2.default)('#user-btn').click(toggleUserMenu);
    (0, _jquery2.default)('#list-adder-btn').click(openListAdderForm);
    (0, _jquery2.default)('#list-adder-close-btn').click(closeListAdderForm);
    (0, _jquery2.default)('#boards-list-btn').click(toggleBoardsLists);
    (0, _jquery2.default)('#board-menu-btn').click(openBoardMenu);
    (0, _jquery2.default)('#board-menu-close-btn').click(closeBoardMenu);
    (0, _jquery2.default)('#add-label-btn').click(toggleAddLabelMenu);
    (0, _jquery2.default)('#new-card-modal-bg').click(closeNewCard);
    (0, _jquery2.default)('#close-new-card-btn').click(closeNewCard);
    (0, _jquery2.default)('#close-card-btn').click(closeFullCard);
    (0, _jquery2.default)('#card-modal-bg').click(closeFullCard);
    (0, _jquery2.default)('#list-adder-submit-btn').click(addNewList);
    (0, _jquery2.default)('#add-card-btn').click(addNewCard);
    (0, _jquery2.default)('#delete-card-btn').click(deleteCard);
    (0, _jquery2.default)('.add-label-selector').click(addNewLabel);
    (0, _jquery2.default)('#send-comment-btn').click(addNewComment);
    (0, _jquery2.default)('#board-member-add-menu-btn').click(toggleBoardMemberAddMenu);
    (0, _jquery2.default)('#add-board-member-btn').click(addBoardMember);
    (0, _jquery2.default)('#logout-btn').click(sendToLogOut);
